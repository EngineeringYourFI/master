...
This tool provides visualizations to assist a user in learning how early retirement affects social security income.

## Getting Started

Modify the inputs in the ImpactOfFIREonSocSecTemplate.py file and run that file as the driver script.
...
* https://engineeringyourfi.com/impact-of-fire-on-social-security-income/
...
Feel free to modify/add content as desired, and repost as desired, but please provide attribution to engineeringyourfi.com (in particular https://engineeringyourfi.com/impact-of-fire-on-social-security-income/).
