# Mnimizing Warehouse Club Membership Fees Tool

This tool provides visualizations to assist a user in deciding how long to wait between purchasing annual memberships at warehouse clubs such as Costco, Sam's Club, and BJ's.

## Getting Started

Modify the inputs in the MinimizeWarehouseMembershipFeesTemplate.py file and run that file as the driver script.
...
Feel free to modify/add content as desired, and repost as desired, but please provide attribution to engineeringyourfi.com (in particular **TBD**).
