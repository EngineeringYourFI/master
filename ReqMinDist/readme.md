# Required minimum distribution for a given age and pretax asset value tool

This tool allows a user to compute the required minimum distribution for a given age and pretax asset value. 

## Getting Started

Modify the inputs in the ReqMinDistTemplate.py file and run that file as the driver script.
...
* https://engineeringyourfi.com/the-irs-wont-wait-forever-required-minimum-distributions/
