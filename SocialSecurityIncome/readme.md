# Compute Social Security Income Tool

This tool allows a user to compute social security income.

## Getting Started

Modify the inputs in the SocialSecurityIncomeTemplate.py file and run that file as the driver script.
...
* https://engineeringyourfi.com/computing-social-security-income/
