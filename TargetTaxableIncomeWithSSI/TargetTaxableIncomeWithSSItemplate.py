...
# TargetTaxableIncomeWithSSItemplate.py
...
# Retirement Income
# Non-qualified dividends that count as standard income
# Also include any other sources of income you can’t easily dial up and down (e.g. a pension)
CurrentAnnualNonQualifiedDividends = 0.
# Social security income
SocialSecurityPayments = np.array([20000], dtype=float) # other filing status
# SocialSecurityPayments = np.array([20000,20000], dtype=float) # married filing jointly
...
NonSSInoTargeting = SingleStandardDeduction # single filing status
# NonSSInoTargeting = MarriedStandardDeduction # married filing jointly
# includes qualified dividends:
LTcapGainsNoTargeting = SingleIncomeBracketLTcapGainsMins[1] - SingleStandardDeduction # single filing status
# LTcapGainsNoTargeting = MarriedIncomeBracketLTcapGainsMins[1] - MarriedStandardDeduction # married filing jointly
...
ComputeTaxesWithNoTargeting = False
