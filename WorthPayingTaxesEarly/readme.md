# Worth Paying Taxes Early Evaluation Tool

This tool allows a user to consider whether it's worth reducing RMDs by withdrawing more than standard deduction from pre-tax accounts before RMDs start

## Getting Started

Modify the inputs in the WorthPayingTaxesEarlyTemplate.py file and run that file as the driver script.
...
* https://engineeringyourfi.com/is-it-worth-using-lower-tax-brackets-to-reduce-rmds-later/
