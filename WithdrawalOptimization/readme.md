...
This tool allows a user to simulate a retirement scenario, employing an optimal withdrawal method/sequence of assets to minimize taxes, maximize ACA subsidies, ensure sufficient funds always available, and maximize long term growth of assets

## Getting Started

Modify the inputs in the WithdrawalOptimizationTemplate.py file and run that file as the driver script.
...
* https://engineeringyourfi.com/withdrawing-money-after-fire/#htoc-code
* https://engineeringyourfi.com/fire-withdrawal-strategy-algorithms/
